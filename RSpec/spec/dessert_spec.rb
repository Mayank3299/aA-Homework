...
describe Dessert do
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do 
      ingredients= ["chocolate", "namak", "shakkar", "pudinaaaa"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do 
      allow(chef).to receive(:titleize).and_return("Chef Tuktuku")
      expect(brownie.serve).to eq("Chef Tuktuku has made 100 brownies!")
    end
  end
