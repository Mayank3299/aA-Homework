...
describe Player do
    ...
    describe '#take_bet' do
        ...
        it 'should raise an error if the bet is more than bankroll' do
            ...
            end.to raise_error('bet amount should be less than bankroll')
        end 
    end
    ...
    describe '#return_cards' do
        ...
        it 'should return the player cards' do
    ...
    describe '#folded?' do
        ...
        it 'return true if player is folded' do
            player.fold
            expect(player).to be_folded
        end
